      ...
      <div className="relative container mx-auto px-4 text-center">
        ...
        >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-primary text-primary-foreground font-bold uppercase tracking-wider rounded-sm animate-pulse-glow transition-all hover:bg-primary/90 text-base cursor-pointer"
          >
